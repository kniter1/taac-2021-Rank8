...
class mAPMeter(Meter):
    ...
    def caculate(self, output, target):
        self.add(output, target)
        return self.value()

# %%
map_calculator = mAPMeter()
pred = torch.tensor([
    [0.443, 0.124, 0.678, 0.335],
    [0.354, 0.125, 0.456, 0.127],
    [0.335, 0.678, 0.456, 0.789]
])
target = torch.tensor([
    [0., 0., 1., 1.],
    [0., 1., 0., 1.],
...
map_calculator = mAPMeter()
test_map = map_calculator.caculate(pred, target)
test_map
# %%
